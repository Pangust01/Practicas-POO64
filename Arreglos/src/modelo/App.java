...
public class App {
    public static void main(String[] args) throws Exception {
         ...
         */
        //int resultado = dataStructuresPrep.powerAlgorithm(2,3);
        //boolean resultado2 = dataStructuresPrep.isPerfectNumber(8589869056.0);
        boolean resultado3 = dataStructuresPrep.isPerfectNumber2(8589869056.0);
        ...
        System.out.println("su numero es perfecto?: "+resultado3);
