...
public class EmpleadoAsalariado extends Empleado {
    ...
    public double calcularSalario() {
        ...
        double valorCargasFamiliares = 0;

        if (aniosAntiguedad > 1) {
            valorAntiguedad = salario / 12;
        }
        if (cargasFamiliares == 1) {
            valorCargasFamiliares = 30;
        } else if (cargasFamiliares == 2) {
            valorCargasFamiliares = 60;
        } else if (cargasFamiliares == 3) {
            valorCargasFamiliares = 120;
        } else if (cargasFamiliares == 4) {
            valorCargasFamiliares = 240;
        } else if (cargasFamiliares >= 5) {
            valorCargasFamiliares = 480;
        }
        return (valorAntiguedad + valorCargasFamiliares);
    }
    ...
    public String toString(Empleado Emp1) {
        ...
        return "Su cedula es " + cedula + "\n" +
                ...
                "Su salario es de " + calcularSalario(calcularSalario()) + " $\n" +
